...
export const AUDIT_ACTIONS = [
  ...
  "admission.approve",
  "admission.reject",
  "admission_exam.round_create",
  "admission_exam.round_open",
  "admission_exam.round_close",
  "admission_exam.round_cancel",
  "admission_exam.round_delete",
  "admission_exam.result_draft",
  "admission_exam.result_publish",
  "admission_exam.result_revise",
  "activity_transcript.student_submit",
  "activity_transcript.staff_record",
  "activity_transcript.institution_record",
